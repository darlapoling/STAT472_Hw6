...
```{r}
pacman::p_load(survey, weights, SDAResources, nrba)
```
...
mean(teachers$preprmin)
var(teachers$preprmin)
mean(teachnr$preprmin)
var(teachnr$preprmin)

mean(teachers$hrwork)
var(teachers$hrwork)
mean(teachnr$hrwork)
var(teachnr$hrwork)

mean(teachers$assist)
var(teachers$assist)
mean(teachnr$assist)
var(teachnr$assist)
```
