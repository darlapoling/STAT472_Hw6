...
par(mfrow=c(1, 2))
hist(teachers$hrwork, xlim=c(-10, 60), main = "Required Hours at Work for Respondents")
hist(teachnr$hrwork, xlim=c(-10, 60), main = "Required Hours at Work for Non-Respondents")
