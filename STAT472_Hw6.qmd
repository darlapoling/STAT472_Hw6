...
"Standard error estimates for our overall national sample show that we can be 95% confident that the figures we have obtained have an error margin, plus or minus, of less than 0.2%." This is a width of 0.4, thwe width of the interval given is 26.4-25=1.4. This is much larger than the actual range provided with 95% confidence, so it can't be true.
